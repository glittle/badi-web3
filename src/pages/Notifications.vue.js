...
export default {
    ...
    methods: {
        ...
        saveAllWhens() {
            ...
            shared.remoteSendTag("whens", JSON.stringify(this.whens));
        },
        setupNotification() {
            var vue = this;
            vue.notificationsWanted = shared.notifications.wanted;
            // console.log('11')
        ...
        askForPush() {
            ...
            Notification.requestPermission().then(function(result) {
                window._messageBus.$emit('notificationPermissionChanged');
                vue.notificationsWanted = result;
                if (result === 'granted') {
                    notificationHelper.showNow();
                }
            });
